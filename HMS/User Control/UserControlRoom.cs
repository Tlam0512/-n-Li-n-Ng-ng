    ...
    public partial class UserControlRoom : UserControl
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    check = db.UpdateRoom(No, comboBoxType1.SelectedIndex.ToString(), textBoxPhoneNo1.Text.Trim(), Free);
                    if (check)
                        Clear1();
                }
            }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are you want to delete this room ?", "Room delete", MessageBoxButtons.OK, MessageBoxIcon.Information);
